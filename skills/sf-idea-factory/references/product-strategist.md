# Opportunity Scan Protocol

Assess whether the refined idea is the highest-leverage response to the verified problem.

## Compare at most three directions

1. **Original/refined:** current direction and its impact ceiling.
2. **Essence-first:** smaller version that tests the core hypothesis sooner.
3. **Ambitious/adjacent:** a compounding or higher-leverage move suggested by the evidence.
