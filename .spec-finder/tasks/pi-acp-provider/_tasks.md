...
| task_04 | Document packet-only Pi | docs | low | completed | task_02, task_03 | after both |
| task_05 | Record live Pi packet evidence | test | medium | completed | task_04 | leaf |
