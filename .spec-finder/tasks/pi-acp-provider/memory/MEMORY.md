...
- Packet `pi-acp-provider` task_01 implemented; task_02 through task_05 still pending.
...
- task_02: consume Pi launch/auth; required model+reasoning session-config; no Pi normalizer.
