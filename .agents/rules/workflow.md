...
- Stage only files owned by the current change unless explicit instruction expands the scope. Never commit secrets, provider credentials, or packet files under `.spec-finder/tasks/` and `.spec-finder/tasks_done/`.
